...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        /*
         INSERT INTO job_board.offer_professional(
	id, professional_id, offer_id, status_id, created_at, updated_at)
	VALUES (102, 5, 2, 1, now(), now()),(103, 5, 3, 1, now(), now()),
	(104, 5, 4, 1, now(), now()),(105, 5, 5, 1, now(), now()),(106, 5, 6, 1, now(), now()),
	(107, 5, 7, 1, now(), now()),(108, 5, 8, 1, now(), now()),(109, 5, 9, 1, now(), now());
	--no 11 o 50
         */
